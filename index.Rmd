...
- A somewhat faster C implementation is now used by default for real-valued dense and some sparse problems. Use the `fastpath=FALSE` parameter to run the original reference R implementation.
