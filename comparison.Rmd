...
then computes the left singular vectors as $U_k = A V_k D_k ^ {-1}$.
...
estimates are slightly more accurate than `svd` in this example (your results
may vary depending on BLAS library in use).

The `bdiff` function below compares the squared 2-norm errors of singular vectors
